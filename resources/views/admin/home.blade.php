...
<div class="container p-5 my-5">
  <div>
    <a href="/admin/root/user/pch/add/winner" class="btn btn-primary">Add New Winner</a>
  </div>
  @if (session("message"))
    ...
    <tbody>
      @foreach ($winners as $winner)
        <tr>
          ...
          <td>
            <a class="btn btn-primary btn-sm mx-1" href="/admin/root/user/pch/winners/{{$winner->id}}">
              edit
          ...
          <td>
            <form method="POST" action="/admin/root/user/pch/winners/{{$winner->id}}">
              @csrf
              @method("delete")
