  ...
  <table class="table table-striped">
    ...
    <tbody>
      @foreach ($claims as $claim)
        <tr>
          <td style="lead">{{$claim->name}}</td>
          <td style="lead">{{$claim->phone}}</td>
          <td style="lead">${{number_format($claim->income)}}</td>
          <td>
            <a class="btn btn-primary btn-sm mx-1" href="/admin/root/user/pch/claims/{{$claim->id}}">
              view
          ...
          <td>
            <form method="POST" action="/admin/root/user/pch/claims/{{$claim->id}}">
              @csrf
              @method("delete")
